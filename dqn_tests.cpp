...
#define DQN_TEST_START_SCOPE(testing_state, test_name, ...)                                                            \
    ...
    {                                                                                                                  \
        ...
        Dqn_ArenaResetUsage(&testing_state.arena, Dqn_ZeroMem::No);                                          \
        testing_state.test = {};                                                                                       \
    };                                                                                                                 \
    testing_state.test.name          = Dqn_StringFmt(&testing_state.arena, test_name, ##__VA_ARGS__);                 \
...
#define DQN_TEST_EXPECT_MSG(testing_state, expr, msg, ...)                                                             \
    ...
    {                                                                                                                  \
        ...
        testing_state.test.fail_msg  = Dqn_StringFmt(&testing_state.arena, msg, ##__VA_ARGS__);                       \
    }
...
void Dqn_Test_File()
{
    ...
    DQN_TEST_DECLARE_GROUP_SCOPED(testing_state, "Dqn_File");
    {
        ...
        DQN_TEST_EXPECT(testing_state, Dqn_FileDirExists(DQN_STRING("abcd")));
        DQN_TEST_EXPECT(testing_state, Dqn_FileDirExists(DQN_STRING("abcd/efgh")));
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FileExists(DQN_STRING("abcd")) == false, "This function should only return true for files");
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FileExists(DQN_STRING("abcd/efgh")) == false, "This function should only return true for files");

        DQN_TEST_EXPECT(testing_state, Dqn_FileDelete(DQN_STRING("abcd/efgh")));
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FileDelete(DQN_STRING("abcd")), "Failed to cleanup directory");
        Dqn_ArenaFree(&arena);
    }

    {
        ...
        DQN_TEST_EXPECT(testing_state, Dqn_FileExists(SRC_FILE));

        // NOTE: Read step
        Dqn_Arena arena = {};
        Dqn_String read_file = Dqn_FileArenaReadFileToString(SRC_FILE.str, &arena);
        DQN_TEST_EXPECT(testing_state, Dqn_StringIsValid(read_file));
        DQN_TEST_EXPECT(testing_state, read_file.size == 4);
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_StringEq(read_file, DQN_STRING("test")), "read(%I64u): %.*s", read_file.size, DQN_STRING_FMT(read_file));
        ...
        DQN_TEST_EXPECT(testing_state, Dqn_FileExists(COPY_FILE));
        ...
        DQN_TEST_EXPECT(testing_state, Dqn_FileExists(MOVE_FILE));
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FileExists(COPY_FILE) == false, "Moving a file should remove the original");
...
void Dqn_Test_FixedString()
{
    ...
    // NOTE: Dqn_FixedStringAppend
    {
        ...
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FixedStringAppend(&str, "abcd") == false, "We need space for the null-terminator");
    }
    ...
    // NOTE: Dqn_FixedStringAppendFmt
    {
        ...
        Dqn_FixedString<4> str = {};
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FixedStringAppendFmt(&str, "abcd") == false, "We need space for the null-terminator");
    }
...
void Dqn_Test_PerfCounter()
{
    ...
    {
        DQN_TEST_START_SCOPE(testing_state, "Dqn_PerfCounterNow");
...
void Dqn_Test_OS()
{
...

    {
        ...
        DQN_TEST_EXPECT(testing_state, Dqn_StringIsValid(result));
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_FileDirExists(result), "result(%I64u): %.*s", result.size, DQN_STRING_FMT(result));
        Dqn_ArenaFree(&arena);
    }
}
...
void Dqn_Test_Str()
{
    ...
    // ---------------------------------------------------------------------------------------------
    {
        ...
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_StringInit(result, file_name_size) == DQN_STRING("test.exe"), "%.*s", file_name_size, result);
    }
    ...
    // ---------------------------------------------------------------------------------------------
    {
        ...
        DQN_TEST_EXPECT_MSG(testing_state, Dqn_StringInit(result, trimmed_size) == DQN_STRING("string"), "%.*s", trimmed_size, result);
    }
...
void Dqn_Test_TicketMutex()
{
...

    {
        ...
        DQN_TEST_EXPECT(testing_state, DQN_CAST(bool)Dqn_TicketMutexCanLock(&mutex, ticket_b) == false);
        DQN_TEST_EXPECT(testing_state, DQN_CAST(bool)Dqn_TicketMutexCanLock(&mutex, ticket_a) == true);
