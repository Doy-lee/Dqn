...
Dqn_Tester Dqn_Test_File()
{
    ...
    DQN_TESTER_BEGIN_GROUP("Dqn_Fs");
    {
        ...
        Dqn_Tester_Begin(&test, "Make directory recursive \"abcd/efgh\"");
...
Dqn_Tester Dqn_Test_M4()
{
    ...
    {
        Dqn_Tester_Begin(&test, "Simple translate and scale matrix");
...
Dqn_Tester Dqn_Test_DSMap()
{
    ...
    {
        Dqn_Tester_Begin(&test, "Erase non-existent item from map");
        Dqn_DSMap<int> map = Dqn_DSMap_Init<int>(128);
        Dqn_DSMap_Erase(&map, 3 /*hash*/, Dqn_ZeroMem_No);
        DQN_TESTER_ASSERTF(&test, map.count == 0, "count: %I64d", map.count);
        Dqn_DSMap_Free(&map, Dqn_ZeroMem_No);
...
Dqn_Tester Dqn_Test_Map()
{
    ...
    {
        Dqn_Tester_Begin(&test, "Add r-value item and get them back out again");
        Dqn_Map<int>       map   = Dqn_Map_InitWithArena<int>(&arena, 1);
        Dqn_MapEntry<int> *entry_a = Dqn_Map_AddCopy(&map, 3 /*hash*/, 5, Dqn_MapCollideRule::Overwrite);
        Dqn_MapEntry<int> *entry_b = Dqn_Map_AddCopy(&map, 4 /*hash*/, 6, Dqn_MapCollideRule::Chain);
    ...
    {
        Dqn_Tester_Begin(&test, "Add r-value item and erase it");
        Dqn_Map<int>       map   = Dqn_Map_InitWithArena<int>(&arena, 1);
        Dqn_Map_AddCopy(&map, 3 /*hash*/, 5, Dqn_MapCollideRule::Overwrite);
    ...
    {
        Dqn_Tester_Begin(&test, "Add r-value item and erase it, zeroing the memory out");
        Dqn_Map<int>       map   = Dqn_Map_InitWithArena<int>(&arena, 1);
        Dqn_Map_AddCopy(&map, 3 /*hash*/, 5, Dqn_MapCollideRule::Overwrite);
        Dqn_Map_AddCopy(&map, 4 /*hash*/, 6, Dqn_MapCollideRule::Chain);
        Dqn_Map_Get(&map, 3 /*hash*/);
...
Dqn_Tester Dqn_Test_Intrinsics()
{
    ...
    {
        Dqn_Tester_Begin(&test, "Dqn_Atomic_AddU32");
        uint32_t val = 0;
    ...
    {
        Dqn_Tester_Begin(&test, "Dqn_Atomic_AddU64");
        uint64_t val = 0;
    ...
    {
        Dqn_Tester_Begin(&test, "Dqn_Atomic_SubU32");
        uint32_t val = 1;
    ...
    {
        Dqn_Tester_Begin(&test, "Dqn_Atomic_SubU64");
        uint64_t val = 1;
    ...
    {
        Dqn_Tester_Begin(&test, "Dqn_Atomic_SetValue32");
        long a = 0;
        long b = 111;
    ...
    {
        Dqn_Tester_Begin(&test, "Dqn_Atomic_SetValue64");
        int64_t a = 0;
        int64_t b = 111;
...
Dqn_Tester Dqn_Test_Rect()
{
    ...
    {
        {
            Dqn_Tester_Begin(&test, "No intersection");
        ...
        {
            Dqn_Tester_Begin(&test, "A's min intersects B");
        ...
        {
            Dqn_Tester_Begin(&test, "B's min intersects A");
            Dqn_Rect a  = Dqn_Rect_InitFromPosAndSize(Dqn_V2( 0,  0), Dqn_V2(100, 100));
        ...
        {
            Dqn_Tester_Begin(&test, "A's max intersects B");
            Dqn_Rect a  = Dqn_Rect_InitFromPosAndSize(Dqn_V2(-50, -50), Dqn_V2(100, 100));
            Dqn_Rect b  = Dqn_Rect_InitFromPosAndSize(Dqn_V2(  0,   0), Dqn_V2(100, 100));
            Dqn_Rect ab = Dqn_Rect_Intersection(a, b);
        ...
        {
            Dqn_Tester_Begin(&test, "B's max intersects A");
            Dqn_Rect a  = Dqn_Rect_InitFromPosAndSize(Dqn_V2(  0,   0), Dqn_V2(100, 100));
            Dqn_Rect b  = Dqn_Rect_InitFromPosAndSize(Dqn_V2(-50, -50), Dqn_V2(100, 100));
            Dqn_Rect ab = Dqn_Rect_Intersection(a, b);
        ...
        {
            Dqn_Tester_Begin(&test, "B contains A");
        ...
        {
            Dqn_Tester_Begin(&test, "A contains B");
            Dqn_Rect a  = Dqn_Rect_InitFromPosAndSize(Dqn_V2( 0,  0), Dqn_V2(100, 100));
        ...
        {
            Dqn_Tester_Begin(&test, "A equals B");
            Dqn_Rect a  = Dqn_Rect_InitFromPosAndSize(Dqn_V2(0, 0), Dqn_V2(100, 100));
            Dqn_Rect b  = a;
            Dqn_Rect ab = Dqn_Rect_Intersection(a, b);
...
Dqn_Tester Dqn_Test_OS()
{
    ...
    {
        Dqn_Tester_Begin(&test, "Generate secure RNG bytes with nullptr");
    ...
    {
        Dqn_Tester_Begin(&test, "Generate secure RNG 32 bytes");
        char const ZERO[32] = {};
        char       buf[32]  = {};
    ...
    {
        Dqn_Tester_Begin(&test, "Generate secure RNG 0 bytes");
        char buf[32] = {};
        buf[0] = 'Z';
    ...
    {
        Dqn_Tester_Begin(&test, "Query executable directory");
        Dqn_Arena arena = {};
...
Dqn_Tester Dqn_Test_CString8()
{
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "To I64: Convert nullptr");
    ...
    {
        Dqn_Tester_Begin(&test, "To I64: Convert empty string");
    ...
    {
        Dqn_Tester_Begin(&test, "To I64: Convert \"1\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To I64: Convert \"-0\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To I64: Convert \"1.2\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To I64: Convert \"1,234\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To I64: Convert \"12a3\"");
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "To U64: Convert nullptr");
    ...
    {
        Dqn_Tester_Begin(&test, "To U64: Convert empty string");
    ...
    {
        Dqn_Tester_Begin(&test, "To U64: Convert \"1\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To U64: Convert \"-0\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To U64: Convert \"1.2\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To U64: Convert \"1,234\"");
    ...
    {
        Dqn_Tester_Begin(&test, "To U64: Convert \"12a3\"");
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "Find: String (char) is not in buffer");
    ...
    {
        Dqn_Tester_Begin(&test, "Find: String (char) is in buffer");
        char const buf[]  = "836a35becd4e74b66a0d6844d51f1a63018c7ebc44cf7e109e8e4bba57eefb55";
        char const find[] = "6";
        char const *result = Dqn_CString8_Find(buf, find, Dqn_CString8_ArrayCountI(buf), Dqn_CString8_ArrayCountI(find));
        DQN_TESTER_ASSERT(&test, result != nullptr);
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "File name from Windows path");
    ...
    {
        Dqn_Tester_Begin(&test, "File name from Linux path");
        Dqn_isize file_name_size = 0;
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "Trim prefix");
    ...
    {
        Dqn_Tester_Begin(&test, "Trim prefix, nullptr trimmed size");
        char const  prefix[]     = "@123";
        char const  buf[]        = "@123string";
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "Is all digits fails on non-digit string");
        char const buf[]  = "@123string";
    ...
    {
        Dqn_Tester_Begin(&test, "Is all digits fails on nullptr w/ size");
    ...
    {
        Dqn_Tester_Begin(&test, "Is all digits fails on 0 size w/ string");
        char const buf[]  = "@123string";
    ...
    {
        Dqn_Tester_Begin(&test, "Is all digits success");
        char const buf[]  = "23";
        Dqn_b32    result = Dqn_CString8_IsAllDigits(buf, Dqn_CString8_ArrayCountI(buf));
    ...
    {
        Dqn_Tester_Begin(&test, "Is all digits fails on whitespace");
        char const buf[]  = "23 ";
        Dqn_b32    result = Dqn_CString8_IsAllDigits(buf, Dqn_CString8_ArrayCountI(buf));
...
Dqn_Tester Dqn_Test_String8()
{
    ...
    {
        Dqn_Tester_Begin(&test, "Allocate string from arena");
        Dqn_Arena arena   = {};
    ...
    // ---------------------------------------------------------------------------------------------
    {
        Dqn_Tester_Begin(&test, "Trim prefix with matching prefix");
    ...
    {
        Dqn_Tester_Begin(&test, "Trim prefix with non matching prefix");
        Dqn_String8 input  = DQN_STRING8("nft/abc");
    ...
    {
        Dqn_Tester_Begin(&test, "Trim suffix with matching suffix");
        Dqn_String8 input  = DQN_STRING8("nft/abc");
    ...
    {
        Dqn_Tester_Begin(&test, "Trim suffix with non matching suffix");
        Dqn_String8 input  = DQN_STRING8("nft/abc");
    ...
    {
        Dqn_Tester_Begin(&test, "Is all digits fails on string w/ 0 size");
        char const buf[]  = "@123string";
...
Dqn_Tester Dqn_Test_TicketMutex()
{
    ...
    DQN_TESTER_BEGIN_GROUP("Dqn_TicketMutex");
    {
        ...
        // written correctly.
        Dqn_Tester_Begin(&test, "Ticket mutex start and stop");
    ...
    {
        Dqn_Tester_Begin(&test, "Ticket mutex start and stop w/ advanced API");
        Dqn_TicketMutex mutex = {};
...
Dqn_Tester Dqn_Test_Win()
{
    ...
    {
        Dqn_Tester_Begin(&test, "String8 to String16 size required");
    ...
    {
        Dqn_Tester_Begin(&test, "String16 to String8 size required");
    ...
    {
        Dqn_Tester_Begin(&test, "String8 to String16");
        Dqn_Arena arena        = {};
    ...
    {
        Dqn_Tester_Begin(&test, "String16 to String8: No null-terminate");
        Dqn_Arena arena    = {};
...
Dqn_Tester Dqn_Test_Keccak()
{
    ...
    for (int hash_type = 0; hash_type < Hash_Count; hash_type++)
    {
        ...
        {
            Dqn_Tester_Begin(&test, "%.*s - Input: %.*s", DQN_STRING_FMT(DQN_TESTS__HASH_STRING[hash_type]), DQN_CAST(int)DQN_MIN(input.size, 54), input.data);
            Dqn_Test__KeccakDispatch(&test, hash_type, input);
            Dqn_Tester_End(&test);
        }

        Dqn_Tester_Begin(&test, "%.*s - Deterministic random inputs", DQN_STRING_FMT(DQN_TESTS__HASH_STRING[hash_type]));
